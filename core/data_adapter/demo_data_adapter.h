...
public:
    NetBaseDataTypeVec doCreateInput(std::vector< float > &_input_data, size_t _batch_size, DataShapeVec &_shape) {
    ...
    std::vector< float > doCreateOutput(NetBaseDataTypeVec &_output) {
